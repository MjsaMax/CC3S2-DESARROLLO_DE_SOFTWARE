...
```bash
*        167e88b 2 minutes ago ("Serrano Arostegui Max Jairo") Commit inicial con README.md
*        b5bb9c1 3 minutes ago ("Serrano Arostegui Max Jairo") Reapply "Estructura inicial de actividad6"
*        040de07 3 minutes ago ("Serrano Arostegui Max Jairo") Revert "Estructura inicial de actividad6"
*        d407cde 5 minutes ago ("Serrano Arostegui Max Jairo") Estructura inicial de actividad6
*        52006a9 4 hours ago ("Serrano Arostegui Max Jairo") Inicio de actividades 5 y 6
```
