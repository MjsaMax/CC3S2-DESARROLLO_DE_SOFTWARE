...
class TestAccountModel:
    ...
    def test_database_uses_memory(self):
        """Verificar que se está usando la base de datos en memoria para testing."""
        from models import app
        # Verificar que la configuración usa SQLite en memoria
